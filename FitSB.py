...
for quantity in ["Rhomass2Dunrolled"]: 
	...
	MC = ["BkgDstarDs"] #"Sig", "SigPart", "BkgDstarDsstar"
	...
	regions = ["SB"]
	with open("datacardSB.txt", "w") as datacard: 
		...
		workspacefile = "workspaceSB.root"
		workspacename = "w"
		...
		datacard.write("bkg_SB_norm rateParam SB bkg {} [{},{}]\n".format(norm["dataD2"]["SB"]/2., 0., norm["dataD2"]["SB"]))
		datacard.write("\n"+"-"*50+"\n")
