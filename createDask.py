...
def create_connection():
    ...
    """
    # From: https://mom6-analysiscookbook.readthedocs.io/en/latest/notebooks/setting_up_dask_jobqueue.html
    import xarray as xr
    from dask_jobqueue import SLURMCluster

    cluster = cluster = SLURMCluster(queue='standard', cores=2, project='t3',
                       memory="2GB", walltime="00:30:00",
